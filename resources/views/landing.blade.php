...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <!--    Document Title-->
    <!-- ===============================================-->
    <title>Dashboard - Rasio Kewirausahaan</title>
    ...
    <!--    Stylesheets-->
    <!-- ===============================================-->
    <link href="{{asset('assets-landing/css/theme.min.css')}}" rel="stylesheet" />
  </head>
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3 bg-light opacity-85" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="/"><img class="d-inline-block align-top img-fluid" src="{{ url('assets/img/logo-kemenkop.png') }}" alt="" width="50" /><span class="text-theme font-monospace fs-4 ps-2"></span></a><button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
        ...
        <div class="container">
          <div class="row align-items-center min-vh-75 min-vh-lg-100">
            <div class="col-md-7 col-lg-6 col-xxl-5 py-6 text-sm-start text-center">
              <h1 class="mt-6 mb-sm-4 fw-semi-bold lh-sm fs-4 fs-lg-5 fs-xl-6">Rasio Kewirausahaan <br class="d-block d-lg-block" /></h1>
              <p class="mb-4 fs-1">
                Rasio kewirausahaan adalah ukuran atau indikator yang digunakan untuk mengukur tingkat aktivitas kewirausahaan dalam suatu wilayah atau ekonomi. Rasio ini sering digunakan untuk menganalisis sejauh mana masyarakat atau sektor usaha tertentu terlibat dalam kegiatan kewirausahaan. Rasio kewirausahaan dapat memberikan wawasan tentang tingkat kreativitas, inovasi, dan daya saing ekonomi.
              </p>
                <a class="btn btn-lg btn-success" href="{{route('login')}}" role="button">Mulai</a>
            </div>
          </div>
        </div>
      </section>
              ...
              <div class="row">
                <div class="col-md-4 mb-5">
                  <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="assets-landing/img/icons/farmer.svg" height="60" alt="" />
                      <div class="card-body">
                ...
                <div class="col-md-4 mb-5">
                  <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="assets-landing/img/icons/growth.svg" height="60" alt="" />
                      <div class="card-body">
                ...
                <div class="col-md-4 mb-5">
                  <div class="card h-100 shadow px-4 px-md-2 px-lg-3 card-span pt-6">
                    <div class="text-center text-md-start card-hover"><img class="ps-3 icons" src="assets-landing/img/icons/planting.svg" height="60" alt="" />
                      <div class="card-body">
            ...
            <div class="col-xl-9 mb-3">
              <div class="row">
                ...
                <div class="col-md-6 mb-5">
                  <div class="card text-white"><img class="card-img" src="assets-landing/img/gallery/short-terms.png" alt="..." />
                ...
                <div class="col-md-6 mb-5">
                  <div class="card text-white"><img class="card-img" src="assets-landing/img/gallery/fully-funded.png" alt="..." />
        ...
        <div class="container-lg">
          <div class="row flex-center">
            <div class="col-12 col-lg-10 col-xl-12">
              <div class="bg-holder" style="background-image:url(assets-landing/img/illustrations/testimonial-bg.png);background-position:top left;background-size:120px 83px;"></div>
              <!--/.bg-holder-->
                ...
                <div class="carousel-item active" data-bs-interval="10000">
                  <div class="row h-100 mx-3 mx-sm-5 mx-md-4 my-md-7 m-lg-7 mt-7">
                    <div class="col-md-4 mb-5 mb-md-0">
                      <div class="card h-100 shadow">
                        <div class="card-body my-3">
                          <div class="align-items-xl-center d-block d-xl-flex px-3"><img class="img-fluid me-3 me-md-2 me-lg-3" src="assets-landing/img/gallery/user-1.png" width="50" alt="" />
                    ...
                    <div class="col-md-4 mb-5 mb-md-0">
                      <div class="card h-100 shadow">
                        <div class="card-body my-3">
                          <div class="align-items-xl-center d-block d-xl-flex px-3"><img class="img-fluid me-3 me-md-2 me-lg-3" src="assets-landing/img/gallery/user-2.png" width="50" alt="" />
                            <div class="flex-1 align-items-center pt-2">
                    ...
                    <div class="col-md-4 mb-5 mb-md-0">
                      <div class="card h-100 shadow">
                        <div class="card-body my-3">
                          <div class="align-items-xl-center d-block d-xl-flex px-3"><img class="img-fluid me-3 me-md-2 me-lg-3" src="assets-landing/img/gallery/user-3.png" width="50" alt="" />
                            <div class="flex-1 align-items-center pt-2">
      ...
      <section class="py-0" id="contact">
        ...
        <div class="container">
          ...
          <div class="row flex-center py-5">
            <div class="col-12 col-sm-8 col-md-6 text-center text-md-start"> <a class="text-decoration-none" href="#"><img class="d-inline-block align-top img-fluid" src="assets-landing/img/gallery/logo-icon.png" alt="" width="40" /><span class="text-theme font-monospace fs-3 ps-2">Zou</span></a></div>
    ...
    <script src="{{asset('assets-landing/assets-landing/js/theme.js')}}"></script>
