    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <div class="card">
                ...
                <form action="{{ route('sumber.update',['id' => $sumber->id]) }}" method="POST" enctype="multipart/form-data" class="form-horizontal">
                @method('PUT')
                @csrf
                <div class="card-body">
                        <div class="form-group">
                            <label for="sumber">Sumber</label>
                            <input type="text" class="form-control" name="sumber" value="{{ $sumber->sumber}}">
                        </div>
                        <div class="col-md-12">
